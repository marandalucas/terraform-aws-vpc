...
This stack creates a vpc using the reference the module https://github.com/terraform-aws-modules/terraform-aws-vpc
This stack can create:
 - VPC
 - Public Subnet
 - Private Subnet
 - Internet Gateway
...
| <a name="input_create"></a> [create](#input\_create) | Controls if stack should be created (it affects almost all resources) | `bool` | `true` | no |
...
| <a name="input_instance_tenancy"></a> [instance\_tenancy](#input\_instance\_tenancy) | Name to be used on all the resources as identifier | `string` | `"default"` | no |
